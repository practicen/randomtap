...
class ViewController: UIViewController, GADFullScreenContentDelegate {
    ...
    override func viewDidLoad() {   //画面起動時の処理
        ...
        GADInterstitialAd.load(withAdUnitID:"ca-app-pub-2313732454636490/1144645453",
                               request: request,
    ...
    func randomImage(){
        ...
        if imagerandom % 24 <= 5{
            ...
            if imagerandom % 24 == 0{
                ...
                image3.image = UIImage(named: "井")
                image4.image = UIImage(named: "丼")
            }
            if imagerandom % 24 == 1{
                image2.image = UIImage(named: "♯")
                image3.image = UIImage(named: "丼")
                image4.image = UIImage(named: "井")
                
            }
            
            if imagerandom % 24 == 2{
                image2.image = UIImage(named: "井")
    ...
    @objc func tapCorrect(sender: Any) { //#を押した時の処理
        counter += 1
        counterLabel.text = "\(counter)/\(practicetime)"
    ...
    @objc func tapUncorrect(sender: Any) {  //♯を押した時の処理
    ...
    @objc func tapI(sender: Any) {  //井をタップした際の処理
    ...
    @objc func tapDon(sender: Any) {   //丼をタップした際の処理
